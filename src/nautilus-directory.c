...
nautilus_directory_finalize (GObject *object)
{
    ...
    g_clear_pointer (&directory->details->call_when_ready_hash.active, g_hash_table_unref);
    g_clear_pointer (&directory->details->call_when_ready_hash.inactive, g_hash_table_unref);
...
nautilus_directory_init (NautilusDirectory *directory)
{
    ...
    directory->details->call_when_ready_hash.active = g_hash_table_new (NULL, NULL);
    directory->details->call_when_ready_hash.inactive = g_hash_table_new (NULL, NULL);
