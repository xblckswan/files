...
nautilus_directory_finalize (GObject *object)
{
    ...
    nautilus_queue_destroy (directory->details->high_priority_queue);
    nautilus_queue_destroy (directory->details->low_priority_queue);
    nautilus_queue_destroy (directory->details->extension_queue);
...
nautilus_directory_init (NautilusDirectory *directory)
{
    ...
    directory->details->file_hash = g_hash_table_new_full (g_str_hash, g_str_equal,
                                                           g_free, NULL);
    directory->details->high_priority_queue = nautilus_queue_new (g_direct_hash, g_direct_equal, g_object_unref);
    directory->details->low_priority_queue = nautilus_queue_new (g_direct_hash, g_direct_equal, g_object_unref);
    directory->details->extension_queue = nautilus_queue_new (g_direct_hash, g_direct_equal, g_object_unref);
